...
public class CircleImageView extends ImageView {
	...
	public CircleImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
		...
		mBorderWidth = a.getDimensionPixelOffset(R.styleable.CircularImage_border_width, mBorderWidth);
		a.recycle();
	}
	...
	private void drawBorder(Canvas canvas, final int width, final int height) {
		 ...
		 */
		canvas.drawCircle(width >> 1, height >> 1, (width >> 1) - mBorderWidth, mBorderPaint);
		canvas = null;
	}
	...
	public Bitmap createOvalBitmap(final int width, final int height) {
		...
		final int padding = mBorderWidth != 0 ? mBorderWidth  : 0;
		/**
